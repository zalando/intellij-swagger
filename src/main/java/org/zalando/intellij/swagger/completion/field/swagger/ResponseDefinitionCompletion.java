...
class ResponseDefinitionCompletion extends FieldCompletion {
    ...
    ResponseDefinitionCompletion(final SwaggerCompletionHelper completionHelper, final CompletionResultSet completionResultSet) {
        super(completionHelper, completionResultSet);
    }

    public void fill() {
        Fields.responseDefinition().forEach(this::addUnique);
    }
