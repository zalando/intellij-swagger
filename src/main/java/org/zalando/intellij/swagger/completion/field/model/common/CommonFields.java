...
public class CommonFields {
  ...
  public static List<Field> tag() {
    return ImmutableList.of(
        new StringField("name", true), new StringField("description"), new ExternalDocsField());
  }

  public static List<Field> externalDocs() {
    return ImmutableList.of(new StringField("url", true), new StringField("description"));
  }

  public static List<Field> contact() {
    return ImmutableList.of(
        new StringField("name"), new StringField("url"), new StringField("email"));
  }
