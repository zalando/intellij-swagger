...
public class OpenApiFields {
  ...
  public static List<Field> server() {
    return ImmutableList.of(
        new StringField("url", true), new StringField("description"), new ObjectField("variables"));
  }

  public static List<Field> serverVariable() {
    return ImmutableList.of(
        new ArrayField("enum"), new StringField("default", true), new StringField("description"));
  }
