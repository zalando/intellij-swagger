...
public class OpenApiValueCompletionFactory {
    ...
    public static Optional<ValueCompletion> from(final OpenApiCompletionHelper completionHelper,
        ...
        if (completionHelper.completeSchemaRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "schemas"));
        } else if (completionHelper.completeResponseRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "responses"));
        } else if (completionHelper.completeParameterRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "parameters"));
        } else if (completionHelper.completeExampleRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "examples"));
        } else if (completionHelper.completeRequestBodyRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "requestBodies"));
        } else if (completionHelper.completeHeaderRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "headers"));
        } else if (completionHelper.completeLinkRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "links"));
        } else if (completionHelper.completeCallbackRefValue()) {
            return Optional.of(new ComponentRefValueCompletion(completionHelper, completionResultSet, "callbacks"));
