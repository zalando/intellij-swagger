...
public class FileConstants {
    ...
    public static final String MAIN_SWAGGER_JSON_FILE = MAIN_SWAGGER_FILE_NAME + JSON_FILE_NAME_SUFFIX;
    public static final String MAIN_SWAGGER_YML_FILE = MAIN_SWAGGER_FILE_NAME + YML_FILE_NAME_SUFFIX;
    public static final String MAIN_SWAGGER_YAML_FILE = MAIN_SWAGGER_FILE_NAME + YAML_FILE_NAME_SUFFIX;
