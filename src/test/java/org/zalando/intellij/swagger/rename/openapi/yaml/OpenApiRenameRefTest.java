...
public class OpenApiRenameRefTest extends SwaggerLightCodeInsightFixtureTestCase {
  ...
  public void testRenameLocalResponseReference() {
    testRename(
        "NewNotFound", "rename_component_response.yaml", "rename_component_response_after.yaml");
  }

  public void testRenameLocalParameterReference() {
    testRename(
        "NewParameter", "rename_component_parameter.yaml", "rename_component_parameter_after.yaml");
  }

  public void testRenameLocalExampleReference() {
    testRename(
        "NewExample", "rename_component_example.yaml", "rename_component_example_after.yaml");
  }

  public void testRenameLocalRequestBodyReference() {
    testRename(
        "NewFoo", "rename_component_request_body.yaml", "rename_component_request_body_after.yaml");
  }
  ...
  public void testRenameLocalCallbackReference() {
    testRename(
        "NewCallback", "rename_component_callback.yaml", "rename_component_callback_after.yaml");
  }

  public void testRenameReferenceWithDotInKey() {
    testRename(
        "NewName",
        "rename_component_with_dot_in_key.yaml",
