...
public class ResponsesFileCompletionTest extends SwaggerLightCodeInsightFixtureTestCase {
  ...
  public void testThatAutoCompletionWorksForFileWithSingleDefinitionForYaml() {
    ...
    final AssertableList completions =
        new AssertableList(myFixture.getCompletionVariants("response.yaml"));
  ...
  public void testThatAutoCompletionWorksForFileWithMultipleResponseDefinitionsInRootForYaml() {
    myFixture.copyFileToProject(
        PARTIAL_FILES_PATH + "/response_definitions_in_root.yaml",
  ...
  public void testThatAutoCompletionWorksForFileWithMultipleResponseDefinitionsNotInRootForYaml() {
    myFixture.copyFileToProject(
        PARTIAL_FILES_PATH + "/response_definitions_not_in_root.yaml",
        "response_definitions_not_in_root.yaml");
    final VirtualFile swaggerFile =
        myFixture.copyFileToProject(PARTIAL_FILES_PATH + "/swagger.yaml", "swagger.yaml");
    myFixture.configureFromExistingVirtualFile(swaggerFile);
    ...
    final AssertableList completions =
        new AssertableList(
            myFixture.getCompletionVariants("response_definitions_not_in_root.yaml"));
  ...
  public void testThatAutoCompletionWorksForFileWithSingleDefinitionForYml() {
    ...
    final AssertableList completions =
        new AssertableList(myFixture.getCompletionVariants("response.yml"));
  ...
  public void testThatAutoCompletionWorksForFileWithMultipleResponseDefinitionsInRootForYml() {
    myFixture.copyFileToProject(
        PARTIAL_FILES_PATH + "/response_definitions_in_root.yaml",
        "response_definitions_in_root.yml");
    final VirtualFile swaggerFile =
        myFixture.copyFileToProject(PARTIAL_FILES_PATH + "/swagger.yml", "swagger.yml");
    myFixture.configureFromExistingVirtualFile(swaggerFile);

    final AssertableList completions =
        new AssertableList(myFixture.getCompletionVariants("response_definitions_in_root.yml"));
  ...
  public void testThatAutoCompletionWorksForFileWithMultipleResponseDefinitionsNotInRootForYml() {
    myFixture.copyFileToProject(
        PARTIAL_FILES_PATH + "/response_definitions_not_in_root.yaml",
        "response_definitions_not_in_root.yml");
    final VirtualFile swaggerFile =
        myFixture.copyFileToProject(PARTIAL_FILES_PATH + "/swagger.yml", "swagger.yml");
    myFixture.configureFromExistingVirtualFile(swaggerFile);

    final AssertableList completions =
        new AssertableList(myFixture.getCompletionVariants("response_definitions_not_in_root.yml"));
