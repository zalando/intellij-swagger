...
public class CompletionTest extends JsonAndYamlCompletionTest {
    ...
    public void thatSchemaRefValueIsSuggested() {
        getCaretCompletions("schema_ref")
                .assertContains("#/components/schemas/Pet")
                .isOfSize(1);
    }
    ...
    public void thatExampleRefValueIsSuggested() {
        getCaretCompletions("example_ref")
                .assertContains("#/components/examples/Example")
                .isOfSize(1);
    }

    @Test
    public void thatHeaderRefValueIsSuggested() {
        getCaretCompletions("header_ref")
                .assertContains("#/components/headers/Header")
                .isOfSize(1);
    }

    @Test
    public void thatLinkRefValueIsSuggested() {
        getCaretCompletions("link_ref")
                .assertContains("#/components/links/Link")
                .isOfSize(1);
    }
    ...
    public void thatInValuesAreSuggested() {
        getCaretCompletions("in")
                .assertContains("query", "header", "path", "cookie")
                .isOfSize(4);
    }
    ...
    public void thatFormatValuesAreSuggested() {
        getCaretCompletions("format")
                .assertContains("int32", "int64", "float", "double", "byte", "binary", "date", "date-time", "password",
                        "email", "uuid")
                .isOfSize(11);
    }
    ...
    public void thatStyleValuesAreSuggested() {
        getCaretCompletions("style")
                .assertContains("matrix", "label", "form", "simple", "spaceDelimited", "pipeDelimited", "deepObject")
                .isOfSize(7);
    }
}
